...
The game is implemented in Python. The objective of the game is to win all of the cards.
...
If a player runs out of cards during a war that player immediately loses. If both the players runs out of cards, no one wins.
